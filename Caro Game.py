...
table_dgr = {2: 1, 3: 10, 4: 45, 5: 150, 1: 0, 0: 0}
...
#     state = state.get_value()
    table_score = {5: 100, 4:30, 3:10, 2:2}
    total_score = 0
...
#     print(potential(state, max_dgr))
    return less_dangerous(state, max_dgr, turn) + table_dgr[min(potential_point, 5)] #+ drop_plot(state, ls_opp_point)
